      ...
      <div className="space-y-12 max-w-3xl">
        <div>
          ...
          <p className="text-muted-foreground">
            ...
            with an animated indicator and support for custom indicator styling via <code className="text-primary bg-primary/5 px-1 rounded">indicatorClassName</code>.
          </p>
        </div>
        ...
        <section className="space-y-4">
          ...
          <div className="border border-border rounded-lg p-6 space-y-6">
            ...
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">33% — In progress</p>
              <Progress value={33} />
            </div>
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">66% — More than half</p>
              <Progress value={66} />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">Custom indicator color (green)</p>
        ...
        <section className="space-y-4">
          ...
          <div className="border border-border rounded-lg p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Progress value={0} />
                <p className="text-xs text-muted-foreground text-center">Empty (0%)</p>
              </div>
              <div className="space-y-2">
                <Progress value={50} />
                <p className="text-xs text-muted-foreground text-center">Partial (50%)</p>
              </div>
              <div className="space-y-2">
                <Progress value={100} />
                <p className="text-xs text-muted-foreground text-center">Complete (100%)</p>
              </div>
              <div className="space-y-2">
                <Progress value={40} className="h-4" />
                <p className="text-xs text-muted-foreground text-center">Taller bar (h-4)</p>
              </div>
            </div>
          </div>
          <p className="text-sm text-muted-foreground">
            The indicator slides using a <code className="text-primary bg-primary/5 px-1 rounded">translateX</code> transform with <code className="text-primary bg-primary/5 px-1 rounded">transition-all</code> for smooth animation when the value changes. The track defaults to <code className="text-primary bg-primary/5 px-1 rounded">h-2</code> and <code className="text-primary bg-primary/5 px-1 rounded">rounded-full</code>.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="border border-border rounded-lg p-4">
            ...
            <TokenRow token="--muted" value="Track background (bg-primary/20)" />
          </div>
        </section>
...
<Progress value={100} />`}</CodeBlock>
        ...
        <section className="space-y-4">
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            <p><strong className="text-foreground">ARIA role:</strong> Radix automatically applies <code className="text-primary bg-primary/5 px-1 rounded">role="progressbar"</code> with <code className="text-primary bg-primary/5 px-1 rounded">aria-valuenow</code>, <code className="text-primary bg-primary/5 px-1 rounded">aria-valuemin</code>, and <code className="text-primary bg-primary/5 px-1 rounded">aria-valuemax</code>.</p>
            <p><strong className="text-foreground">Screen readers:</strong> Announce the current percentage. No additional labeling needed unless the context is ambiguous — in that case add an <code className="text-primary bg-primary/5 px-1 rounded">aria-label</code>.</p>
