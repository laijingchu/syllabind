    ...
    <DesignSystemLayout>
      <div className="space-y-12 max-w-3xl">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">The select trigger and expanded dropdown rendered statically for visual reference.</p>
          ...
          <div className="border border-border rounded-lg p-6">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground text-center">With value</p>
              </div>
              <div className="space-y-2">
                <Select disabled>
                  <SelectTrigger>
