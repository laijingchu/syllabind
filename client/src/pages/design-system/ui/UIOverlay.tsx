    ...
    <DesignSystemLayout>
      <div className="space-y-12 max-w-3xl">
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">The overlay rendered in a contained box for visual reference. In production it covers the full viewport.</p>
              ...
              <div className="relative rounded-lg overflow-hidden h-40 border border-border">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="bg-background border border-border rounded-lg p-6 shadow-lg max-w-xs text-center space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">The overlay dims the background to focus attention here.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[60, 80, 90].map(opacity => (
                  <div key={opacity} className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground text-center">bg-black/{opacity}</p>
                  </div>
                ))}
              </div>
