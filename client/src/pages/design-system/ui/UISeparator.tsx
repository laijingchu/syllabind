          ...
          <div className="border border-border rounded-lg p-6 space-y-4">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Another section below.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="border border-border rounded-lg p-6 space-y-6">
            <div className="space-y-2">
              <Separator />
              <p className="text-xs text-muted-foreground">Default (decorative) — hidden from screen readers</p>
            </div>
            <div className="space-y-2">
              <Separator decorative={false} />
              <p className="text-xs text-muted-foreground">Non-decorative — announced by screen readers with <code className="text-primary bg-primary/5 px-1 rounded">role="separator"</code></p>
            </div>
            <div className="space-y-2">
              <Separator className="bg-primary" />
              <p className="text-xs text-muted-foreground">Custom color via className override</p>
            </div>
          </div>
          <p className="text-sm text-muted-foreground">
