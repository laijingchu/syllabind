          ...
          <div className="space-y-8">
            ...
            <DemoCard label="variant=&quot;curator-limit&quot;">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-muted-foreground">Upgrade to Pro for unlimited binders, enrollments, and 130 monthly AI credits.</p>
              </div>
              ...
              <p className="text-center text-xs text-muted-foreground underline">See all plans</p>
            </DemoCard>
            ...
            <DemoCard label="variant=&quot;enrollment-gate&quot;">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-muted-foreground">Free plan allows 1 active enrollment. Upgrade to Pro for unlimited enrollments and 130 monthly credits.</p>
              </div>
              <div className="border rounded-lg p-4 bg-muted/30 space-y-2">
                <p className="font-medium text-sm">Syllabind Pro includes:</p>
                <ul className="text-sm text-muted-foreground space-y-1">
            ...
            <DemoCard label="variant=&quot;insufficient-credits&quot; (Pro user)">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-muted-foreground">This action costs 10 credits. You have 3 credits remaining.</p>
              </div>
              <div className="space-y-2">
            ...
            <DemoCard label="variant=&quot;insufficient-credits&quot; (Free user)">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-muted-foreground">You've used all your free credits. Upgrade to Pro for 130 monthly credits and the ability to purchase more.</p>
              </div>
              <div className="space-y-2">
