              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Barely visible. Tells the user "this responds to interaction."</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Noticeable. Confirms a press or marks a toggled-on state.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="border border-border rounded-lg p-4 space-y-3">
              <h3 className="text-sm font-medium">Adapts to Mode Automatically</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="space-y-2">
              <div className="hover-elevate border border-border rounded-lg p-6 text-center cursor-pointer relative">
                ...
                <p className="text-xs text-muted-foreground mt-1">Subtle brightness shift on mouse-over</p>
              </div>
            ...
            <div className="space-y-2">
              <div className="hover-elevate-2 border border-border rounded-lg p-6 text-center cursor-pointer relative">
                ...
                <p className="text-xs text-muted-foreground mt-1">More visible for important interactive areas</p>
              </div>
              <p className="text-xs text-muted-foreground text-center">
            ...
            <div className="space-y-2">
              <div className="active-elevate border border-border rounded-lg p-6 text-center cursor-pointer relative">
                ...
                <p className="text-xs text-muted-foreground mt-1">Click and hold to see the active state</p>
              </div>
              <p className="text-xs text-muted-foreground text-center">
            ...
            <div className="space-y-2">
              <div className="toggle-elevate toggle-elevated border border-border rounded-lg p-6 text-center cursor-pointer relative">
                ...
                <p className="text-xs text-muted-foreground mt-1">Persistent elevation for active state</p>
              </div>
              <p className="text-xs text-muted-foreground text-center">
            ...
            <div className="space-y-2">
              <div className="toggle-elevate border border-border rounded-lg p-6 text-center cursor-pointer relative">
                ...
                <p className="text-xs text-muted-foreground mt-1">No elevation — the default resting state</p>
              </div>
              <p className="text-xs text-muted-foreground text-center">
