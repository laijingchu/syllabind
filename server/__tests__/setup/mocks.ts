...
export const resetAllMocks = () => {
  ...
  if (mockStorage.getSyllabiByCreator) mockStorage.getSyllabiByCreator.mockResolvedValue([]);
  if (mockStorage.listSyllabi) mockStorage.listSyllabi.mockResolvedValue([]);
  ...
  if (mockStorage.batchDeleteSyllabi) mockStorage.batchDeleteSyllabi.mockResolvedValue(undefined);
