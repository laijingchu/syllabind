...
jest.mock('./server/storage', () => ({
  storage: {
    ...
    getSyllabindsByCreator: jest.fn().mockResolvedValue([]),
    listSyllabinds: jest.fn().mockResolvedValue([]),
    listPublishedSyllabinds: jest.fn().mockResolvedValue([]),
    createSyllabus: jest.fn(),
    updateSyllabus: jest.fn(),
    deleteSyllabus: jest.fn(),
    batchDeleteSyllabinds: jest.fn(),
    ...
    getTagsBySyllabindId: jest.fn().mockResolvedValue([]),
